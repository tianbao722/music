...
public class YuePuActiviy4 extends Activity {
    private WebView mWebDownLoadYuePu4;
    ...
    private void initView() {
        mWebDownLoadYuePu4 = findViewById(R.id.web_niurenyuepuwang);
        ...
        mWebDownLoadYuePu4.loadUrl("http://www.ktvc8.com/201852.html");
        mWebDownLoadYuePu4.setWebViewClient(new WebViewClient() {
            @Override
        ...
        this.mContext = this;
        // 这行代码一定加上否则效果不会出现
        mWebDownLoadYuePu4.getSettings().setJavaScriptEnabled(true);
        mWebDownLoadYuePu4.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                WebView.HitTestResult result = mWebDownLoadYuePu4.getHitTestResult();
