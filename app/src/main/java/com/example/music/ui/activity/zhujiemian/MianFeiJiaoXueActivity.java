...
import com.example.music.utils.SoundPoolUtil;

import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

public class MianFeiJiaoXueActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mian_fei_jiao_xue);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            break;
            case R.id.iv_back:
                MianFeiJiaoXueActivity.this.finish();
                break;
            default:
        }
    }
