...
public class XinDiaoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<YinDiaoBean> yinDiaoBeans;
    private Context mContext;
    private onItemClickListener onItemClickListener;

    public void setOnItemClickListener(XinDiaoAdapter.onItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    public XinDiaoAdapter(ArrayList<YinDiaoBean> yinDiaoBeans, Context mContext) {
